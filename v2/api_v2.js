...
const { getBalanceUrl } = require('./src/transaction/mobilemoney/airtel/checkbalance/checkBalance');
const { airtelDisburse } = require('./src/transaction/mobilemoney/airtel/disburse/disburse');
...
// airtel
api_v2.post('/airtel/checKBalance', getBalanceUrl);
api_v2.post('/airtel/disburse', airtelDisburse);
